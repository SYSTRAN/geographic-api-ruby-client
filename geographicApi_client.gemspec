...
Gem::Specification.new do |s|
  s.name        = "geographicApiClient"
  s.version     = GeographicApiClient::Swagger::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["Systran"]
  s.email       = "support-professional@systransoft.com"
  s.homepage     = "http://www.systransoft.com/"
  s.summary     = %q{A ruby wrapper for the Systran geographic APIs}
  s.description = %q{This gem maps to the geographic swagger API}
